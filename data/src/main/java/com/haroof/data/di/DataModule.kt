...
import com.haroof.data.repository.DefaultUserSettingsRepository
...
interface DataModule {
  ...
  @Binds
  fun bindsUserSettingsRepository(userSettingsRepository: DefaultUserSettingsRepository): UserSettingsRepository
}